...
console.log(same([1, 2, 3], [4, 4, 1])); // should be false (must be same frequency)
...
console.log(sameOptimized([1, 2, 3], [4, 1, 9])); // should be true
console.log(sameOptimized([1, 2, 3], [1, 9])); // should be false
console.log(sameOptimized([1, 2, 3], [4, 4, 1])); // should be false (must be same frequency)
